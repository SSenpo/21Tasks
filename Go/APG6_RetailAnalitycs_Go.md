...
Создание web-интерфейса для проекта SQL3 на языке Go.
...
- Программа должна быть реализована с использованием любого MVC-фреймворка (например, Revel)
