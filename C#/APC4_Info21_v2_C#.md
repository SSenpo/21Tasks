APC4.Info21 v2.0 Web

Создание web-интерфейса для проекта SQL2 на языке C#.
...
- Программа должна быть реализована с использованием любого MVC-фреймворка (ASP.NET Core)
