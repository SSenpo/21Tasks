...
Создание web-интерфейса для проекта SQL3 на языке C#.
...
- Программа должна быть реализована с использованием любого MVC-фреймворка (например, ASP.NET Core MVC)
