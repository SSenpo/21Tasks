...
Реализация SmartCalc v4.0 на языке Java.
...
В данном проекте Вам предстоит реализовать на языке программирования Java  расширенную версию обычного калькулятора, 
реализующую те же самые функции, что и разработанные ранее приложения в проектах SmartCalc v1.0, v2.0, v3.0. 
Вам предстоит улучшить знания языка программирования Java, паттерна MVC и основ разработки Web-приложений.
